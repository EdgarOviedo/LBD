USE [Practica1]
GO
/****** Object:  Table [dbo].[table]    Script Date: 20/02/2019 07:45:36 p.m. ******/
DROP TABLE [dbo].[table]
GO
/****** Object:  Table [dbo].[Empleados]    Script Date: 20/02/2019 07:45:36 p.m. ******/
DROP TABLE [dbo].[Empleados]
GO
USE [master]
GO
/****** Object:  Database [Practica1]    Script Date: 20/02/2019 07:45:36 p.m. ******/
...
CREATE DATABASE [Practica1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Practica1', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Practica01.mdf' , SIZE = 4160KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Practica1_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Practica01_log.ldf' , SIZE = 1040KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
USE [Practica1]
GO
/****** Object:  Table [dbo].[Alumnos]    Script Date: 20/02/2019 07:45:36 p.m. ******/
SET ANSI_NULLS ON
GO
